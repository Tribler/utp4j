...
import static net.utp4j.channels.impl.alg.UtpAlgConfiguration.C_CONTROL_TARGET_MICROS;
import static net.utp4j.channels.impl.alg.UtpAlgConfiguration.MAX_BURST_SEND;
import static net.utp4j.channels.impl.alg.UtpAlgConfiguration.MAX_CWND_INCREASE_PACKETS_PER_RTT;
import static net.utp4j.channels.impl.alg.UtpAlgConfiguration.MAX_PACKET_SIZE;
import static net.utp4j.channels.impl.alg.UtpAlgConfiguration.MICROSECOND_WAIT_BETWEEN_BURSTS;
import static net.utp4j.channels.impl.alg.UtpAlgConfiguration.MINIMUM_MTU;
import static net.utp4j.channels.impl.alg.UtpAlgConfiguration.MINIMUM_TIMEOUT_MILLIS;
import static net.utp4j.channels.impl.alg.UtpAlgConfiguration.MIN_PACKET_SIZE;
import static net.utp4j.channels.impl.alg.UtpAlgConfiguration.ONLY_POSITIVE_GAIN;
import static net.utp4j.channels.impl.alg.UtpAlgConfiguration.PACKET_SIZE_MODE;
import static net.utp4j.channels.impl.alg.UtpAlgConfiguration.SEND_IN_BURST;
